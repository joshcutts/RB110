...
output: selected array of integers where the integers are selected if they are at odd element locations (even array index)
...
ALGORITHM:
- iterate through the array and select elements where the index is even

=end

def oddities(arr)
  arr.select.with_index {|_num, i| i.even? }
end
