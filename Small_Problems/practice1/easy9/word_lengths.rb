...
PROBLEM:
input: string
output: array with each string and the length of the string appeneded
...
ALGORITHM:
- iterate through each word of the argued string
- find the length of the string
- interpolate the word & length of the string to a result array
